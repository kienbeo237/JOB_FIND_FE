        ...
        <div className="flex justify-between mb-4">
          <div className="flex items-center">
            <p className="text-gray-600">
              Tài liệu hồ sơ, hoặc tạo mới CV cực nhanh trên JobFind.vn
            </p>
          </div>
          <div className="flex gap-3">
            ...
            <Button
              variant="outline"
              className="border-teal-600 text-teal-600 hover:bg-teal-50 py-2 h-auto"
            >
              ...
              <div className="flex flex-col items-center text-center py-12">
                ...
                <div className="flex flex-wrap gap-3 mt-4 justify-center">
                  ...
                  <Button
                    ...
                    className="border-teal-600 text-teal-600 hover:bg-teal-50 py-2 h-auto"
                  >
                    <Download className="h-4 w-4 mr-2" /> Tải về mẫu để chỉnh
                    sửa
                  </Button>
                  <Button
                    variant="outline"
                    className="border-teal-600 text-teal-600 hover:bg-teal-50 py-2 h-auto"
                  >
                    <Upload className="h-4 w-4 mr-2" /> Tải lên nội dung hoàn
                    chỉnh
                  </Button>
                </div>
              </div>
        ...
        >
          ...
          <TabsContent value="templates" className="mt-0">
            <div className="flex justify-end mb-4">
              <Button
                variant="outline"
                className="text-teal-600 border-teal-600 hover:bg-teal-50 py-2 h-auto"
              >
                ...
                <CardContent className="p-5">
                  ...
                  <div className="flex justify-between">
                    ...
                    <div className="flex gap-3">
                      ...
                      <Button
                        size="sm"
                        className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 h-auto"
                      >

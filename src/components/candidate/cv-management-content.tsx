...
export default function CVManagementContent() {
  ...
  const handleFileUpload = (type: string) => {
    ...
    setTimeout(() => {
      setUploading(false)
      toast.success(`${type === "cv" ? "CV" : type === "video" ? "Video" : "Audio"} đã được tải lên thành công`)
    }, 1500)
  }
      ...
      <div>
        ...
        {cvs.length > 0 ? (
          <div className="space-y-4">
            {cvs.map((cv) => (
              <div key={cv.id} className="bg-white p-4 rounded-lg shadow-sm flex justify-between items-center">
                <div className="flex items-center">
                  <FileText className="text-orange-500 mr-3" />
                  <span>{cv.name}</span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-sm text-gray-500">Cập nhật gần nhất: {cv.lastUpdated}</span>
          ...
          <Card>
            <CardContent className="p-0">
              <div className="flex flex-col items-center text-center py-12">
                <img src="/empty-state-concept.png" alt="Không có CV" className="w-40 h-40 mb-6" />
          ...
          {activeTab === "upload" && (
            <div className="flex flex-col items-center justify-center py-8">
              <div className="w-full max-w-md space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Nhập tên CV mới...</label>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-gray-700 mb-2">Kéo & thả file CV vào đây</p>
                    <p className="text-gray-500 text-sm mb-4">Hỗ trợ: PDF, DOCX, DOC (Max: 5MB)</p>
                    <Button
                      className="bg-orange-500 hover:bg-orange-600"
                ...
                <div className="flex justify-center mt-4">
                  <Button disabled={uploading} className="bg-orange-500 hover:bg-orange-600 min-w-40">
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="bg-blue-50">
                  <CardContent className="p-6 flex flex-col items-center text-center">
                    ...
                    <p className="text-sm text-gray-600 mb-4">(PNG, JPG, dưới 1MB)</p>
                    ...
                    <div className="w-full">
                      <div className="mb-4 text-left">
                        <label className="block text-sm font-medium text-gray-700 mb-2">Chọn ảnh có sẵn:</label>
                ...
                <Card className="bg-emerald-50">
                  <CardContent className="p-6 flex flex-col items-center text-center">
                    ...
                    <Button className="mt-2" onClick={() => handleFileUpload("video")} disabled={uploading}>
                      <Upload className="h-4 w-4 mr-2" />
                      Tải lên
                    </Button>
                  </CardContent>
                ...
                <Card className="bg-purple-50">
                  <CardContent className="p-6 flex flex-col items-center text-center">
                    ...
                    <Button className="mt-2" onClick={() => handleFileUpload("audio")} disabled={uploading}>
                      <Upload className="h-4 w-4 mr-2" />
                      Tải lên
                    </Button>
                  </CardContent>
              ...
              <div className="border-t pt-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Số CMND</label>
                      <Input
                        name="idNumber"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      Giới thiệu bản thân <span className="text-gray-500">(tối đa 500 từ)</span>
                    </label>
                    <textarea
              ...
              <div className="border-t pt-6">
                <h3 className="text-lg font-medium mb-6">* Chọn mẫu CV bên dưới để lưu CV</h3>
                    ...
                    <div key={index} className="flex flex-col">
                      ...
                      <div
                        className={`h-48 cursor-pointer border-2 rounded-md overflow-hidden ${
                          selectedTemplate === index ? "border-orange-500" : "border-gray-200"
                        }`}
                      ...
                      <div className="flex justify-between mt-2">
                        <Dialog>
                          ...
                          <DialogContent className="max-w-4xl h-[80vh]">
                            ...
                            <div className="h-full overflow-auto">
                              <iframe src={template.pdfUrl} className="w-full h-full border-0" title={template.name} />
                            </div>
                          </DialogContent>
                        </Dialog>
                        <Button

      ...
      tempAudio.onloadedmetadata = () => {
        if (tempAudio.duration > 45) {
          toast({
            title: 'Lỗi',
            description:
              'File audio vượt quá 45 giây. Vui lòng chọn file ngắn hơn.',
          });
          setAudioUrl(null);
          setHasAudio(false);
          return;
    ...
    <div className="container mx-auto py-8 px-4 md:px-6">
      <Card className="max-w-2xl mx-auto">
        <CardContent className="p-6">
          <Tabs
            defaultValue={hasAudio ? 'listen' : 'record'}
            value={activeTab}
            ...
            <TabsContent value="record">
              <div className="bg-purple-100 rounded-lg p-6 text-center mb-6">
                <h2 className="text-xl font-semibold text-purple-800 mb-2">
                  Ghi âm giới thiệu bản thân trong 45 giây
                </h2>
                <p className="text-purple-700 text-sm">(Không quá 1 MB)</p>
              </div>

              <p className="text-gray-600 mb-6 text-sm">
                Audio giới thiệu giúp nhà tuyển dụng hiểu thêm về khả năng giao
                tiếp và độ tự tin của bạn. Hãy chuẩn bị trước nội dung và thực
                hiện trong môi trường yên tĩnh để có chất lượng âm thanh tốt
                nhất.
              </p>
              ...
              <div className="flex justify-center gap-4 mt-6">
                {!isRecording ? (
                  <Button
                    className="bg-purple-600 text-white hover:bg-purple-700 min-w-32"
                  ...
                  <Button
                    className="bg-red-500 text-white hover:bg-red-600 min-w-32"

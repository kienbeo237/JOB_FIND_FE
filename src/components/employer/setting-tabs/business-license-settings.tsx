    ...
    <div className="space-y-6">
      <div className="border-b pb-4">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Cập nhật thông tin giấy phép kinh doanh của doanh nghiệp
        </p>
      </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-green-700">
              Thông tin giấy phép kinh doanh được sử dụng để xác thực danh tính
              doanh nghiệp
            </p>
          </div>
        </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-amber-700">
                  Tải lên ảnh chụp rõ giấy phép kinh doanh dạng Jpeg, Png, không
                  quá 1MB
                </p>
              </div>
            </div>
      ...
      <div className="space-y-4 pt-4 border-t">
        <div className="flex items-center space-x-2">
          <FileText className="h-5 w-5 text-teal-600" />
          <h3 className="text-lg font-medium text-teal-600">
            Thông tin đăng ký kinh doanh của doanh nghiệp
          </h3>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Select
                ...
                onValueChange={value =>
                  handleInputChange('recruitmentBudget', value)
                }
              >
                ...
                <SelectContent>
                  <SelectItem value="under-100">
                    Chọn ngân sách (dưới 100tr VND/ 100-200/...)
                  </SelectItem>

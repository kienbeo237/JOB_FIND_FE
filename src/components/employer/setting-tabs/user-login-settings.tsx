  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold tracking-tight">Người dùng đăng nhập</h2>
      ...
      <div className="space-y-4">
        <Card className="p-6 md:p-8">
          <CardHeader className="pb-3">
            <CardTitle>
              Trạng thái: <span className="text-emerald-600">Tài khoản chính</span>
            </CardTitle>
            <div className="mt-2">
              <Alert className="bg-blue-50 border-blue-200">
                <InfoIcon className="h-4 w-4 text-blue-600" />
                <AlertDescription className="text-blue-800">
                  <div className="font-medium">3 cấp độ định danh tài khoản doanh nghiệp:</div>
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input id="fullName" value={formData.fullName} readOnly className="bg-gray-50" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="phone" value={formData.phone} readOnly className="bg-gray-50" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue={formData.position} disabled>
                  ...
                  <SelectContent>
                    <SelectItem value="Trưởng phòng/ giám đốc/ nhân viên">Trưởng phòng/ giám đốc/ nhân viên</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-emerald-600">(Email công ty định danh nhanh hơn)</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="password" type="password" value={formData.password} readOnly className="bg-gray-50" />
              </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="address" value={formData.address} readOnly className="bg-gray-50" />
            </div>

            <div className="border-t pt-6 mt-6">
              <h3 className="text-lg font-semibold mb-4">3 cấp độ định danh tài khoản doanh nghiệp</h3>

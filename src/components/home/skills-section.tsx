...
const blogArticles = [
  {
    ...
    description:
      'Các chiến lược và công cụ giúp lập trình viên quản lý thời gian và tăng năng suất làm việc.',
  ...
  },
  {
    ...
    description:
      'Hướng dẫn chi tiết để tạo một hồ sơ LinkedIn thu hút nhà tuyển dụng trong ngành công nghệ.',
  ...
  },
  {
    ...
    description:
      'Phát triển các kỹ năng mềm quan trọng cho công việc và sự phát triển nghề nghiệp trong kỷ nguyên số.',
  ...
  },
  {
    ...
    description:
      'Những mẹo viết CV hiệu quả để nổi bật và gây ấn tượng với nhà tuyển dụng trong quá trình xin việc.',
  ...
  },
  {
    ...
    description:
      'Khám phá những xu hướng và cơ hội tuyển dụng mới nhất trong ngành công nghệ thông tin năm 2025.',
  ...
  },
  {
    ...
    description:
      'Cập nhật những tin tức mới nhất về công nghệ, sản phẩm và xu hướng trong tháng 5/2025.',
  ...
  },
  {
    ...
    description:
      'Danh sách và phân tích về các công ty công nghệ hàng đầu tại Việt Nam trong năm 2025.',
  ...
  },
  {
    ...
    description:
      'Phân tích chi tiết về thị trường việc làm IT tại Việt Nam trong quý 2 năm 2025.',
  ...
  },
  {
    ...
    description:
      'Cuộc phỏng vấn độc quyền với CEO công ty ABC về chiến lược phát triển và tuyển dụng.',
  ...
  },
  {
    ...
    description:
      'Cập nhật những tin tức mới nhất về thị trường việc làm IT tại Việt Nam trong tháng 4/2025.',
  ...
  },
  {
    ...
    description:
      'Thông tin chi tiết về hội thảo Công nghệ AI 2025 sẽ diễn ra tại Hà Nội vào tháng 6/2025.',
  ...
  },
  {
    ...
    description:
      'Thông tin về workshop kỹ năng phỏng vấn dành cho sinh viên IT sắp tốt nghiệp.',
  ...
  },
  {
    ...
    description:
      'Thông tin chi tiết về ngày hội việc làm IT 2025 sẽ diễn ra tại TP.HCM vào tháng 5/2025.',
    image: '/job-fair.png',
    date: '20/04/2025',
    duration: '3 phút đọc',
    tag: 'Sự kiện',
  ...
  },
  {
    ...
    description:
      'Buổi giao lưu trực tuyến với các chuyên gia tuyển dụng hàng đầu trong ngành công nghệ.',
  ...
  },
  {
    ...
    description:
      'Thông tin về triển lãm Công nghệ 4.0 sẽ diễn ra tại Đà Nẵng vào tháng 7/2025.',
    ...
    <section className="py-14 bg-gray-50">
      <div className="max-w-[1400px] mx-auto px-4">
        <div className="text-center mb-8">
          <h2 className="text-[2.3rem] font-extrabold text-emerald-600 mb-2">
            Góc Cẩm Nang, Báo Chí &amp; Sự Kiện
          </h2>
          <div className="text-gray-500 text-lg">
            Cập nhật tri thức, tin tức và sự kiện công nghệ mới nhất dành cho
            bạn
          </div>
        </div>
                    ...
                    >
                      ...
                      <div className="flex flex-col flex-1 justify-between p-5">
                        <div className="flex items-center gap-2 mb-1.5">
                          <span
                            className={`text-xs font-semibold px-2 py-0.5 rounded ${getTagColor(
                              blog.tag
                            )}`}
                          >
                            {blog.tag}

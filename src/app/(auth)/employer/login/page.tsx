    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-sm">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Đăng nhập tài khoản Nhà tuyển dụng</h1>
          <p className="text-gray-600 mb-6">Cùng tạo dựng lợi thế cho Doanh nghiệp từ hàng triệu ứng viên tiềm năng.</p>
          ...
          <form className="space-y-4">
            ...
            <div>
              <div className="flex justify-between mb-1">
                ...
                <Link href="/employer/forgot-password" className="text-sm text-emerald-600 hover:text-emerald-700">
                  Quên mật khẩu?
                </Link>
              </div>
              <div className="relative">
          ...
          <div className="mt-8">
            <h2 className="text-lg font-semibold text-emerald-700 mb-4">Hỗ trợ nhà tuyển dụng</h2>
            <div className="space-y-2">
              <h3 className="text-emerald-700 font-medium">Tìm kiếm nhân tài qua hồ sơ đã đăng, đăng cấp</h3>
              <p className="text-gray-600 text-sm">
                Tìm kiếm nhân tài qua hồ sơ đã đăng, đăng cấp. Lựa chọn tối ưu với hồ sơ video, audio.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/employer/register" className="text-emerald-600 hover:text-emerald-700">
                Đăng ký ngay
              </Link>
            </p>
          </div>

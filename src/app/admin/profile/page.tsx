...
import { Mail, Shield, Edit, Save, X, Upload, Clock, Activity, Lock, Key } from "lucide-react"
  ...
  return (
    <div className="container mx-auto py-4 px-4 sm:px-6 sm:py-6 max-w-6xl">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        {!isEditing ? (
          <Button onClick={handleEditToggle} variant="outline" className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                {isEditing ? (
                  <Input name="email" value={profile.email} onChange={handleInputChange} className="flex-1" />
                ) : (
              ...
              <div>
                ...
                {isEditing ? (
                  <Textarea name="bio" value={profile.bio} onChange={handleInputChange} className="min-h-[100px]" />
                ) : (
            ...
            <TabsContent value="about">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Your professional information and bio</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div>
                    <h3 className="font-medium mb-2">Bio</h3>
                    {isEditing ? (
                      <Textarea name="bio" value={profile.bio} onChange={handleInputChange} className="min-h-[120px]" />
                    ) : (
                      <p className="text-muted-foreground">{profile.bio}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-7 gap-2 text-center">
                      {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day, i) => (
                        <div
                          key={day}
                          className={`p-2 rounded-md ${i < 5 ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-400"}`}
                        >
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-6">
                    {[
                      {
                        action: "Updated user permissions for Tech Solutions Inc.",
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {[
                        { device: "Windows PC - Chrome", location: "San Francisco, CA", current: true },
                        { device: "iPhone 13 - Safari", location: "San Francisco, CA", current: false },
                        { device: "MacBook Pro - Firefox", location: "New York, NY", current: false },
                      ].map((session, i) => (
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        { title: "Browser Notifications", description: "Get alerts in your browser" },
                        { title: "SMS Notifications", description: "Get text messages for critical alerts" },
                      ].map((item, i) => (
                        <div key={i} className="flex items-center justify-between">
                          <div>
                            <Label htmlFor={`notify-${i}`} className="font-medium">
                              {item.title}
                            </Label>
                    ...
                    <div className="space-y-3">
                      <div className="grid grid-cols-3 gap-3">
                        {["Light", "Dark", "System"].map((theme, i) => (
                          <div
                            key={theme}
                            className={`border rounded-md p-3 text-center cursor-pointer ${i === 0 ? "border-blue-500 bg-blue-50" : ""}`}
                          >
                            {theme}
                          </div>
                        ))}
